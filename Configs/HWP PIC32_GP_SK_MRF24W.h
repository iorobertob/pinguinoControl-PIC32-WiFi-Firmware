...
// LEDs
#define LED0_TRIS			(TRISDbits.TRISD4)	// Ref LED1//ROBERTO:(TRISDbits.TRISD)
#define LED0_IO				(LATDbits.LATD4)//ROBERTO:(LATDbits.LATD0)
#define LED1_TRIS			(TRISDbits.TRISD4)	// Ref LED2//ROBERTO:(TRISDbits.TRISD1)
#define LED1_IO				(LATDbits.LATD4)//ROBERTO:(LATDbits.LATD1)
#define LED2_TRIS			(TRISDbits.TRISD4)	// Ref LED3//ROBERTO:(TRISDbits.TRISD2)
#define LED2_IO				(LATDbits.LATD2)//ROBERTO:(LATDbits.LATD2)
#define LED3_TRIS			(LED2_TRIS)			// No such LED//ROBERTO:(LED2_TRIS)
#define LED3_IO				(LATDbits.LATD4)//ROBERTO:(LATDbits.LATD6)
#define LED4_TRIS			(LED2_TRIS)			// No such LED//ROBERTO:(LED2_TRIS)
#define LED4_IO				(LATDbits.LATD4)//ROBERTO:(LATDbits.LATD6)
#define LED5_TRIS			(LED2_TRIS)			// No such LED//ROBERTO:(LED2_TRIS)
#define LED5_IO				(LATDbits.LATD4)//ROBERTO:(LATDbits.LATD6)
#define LED6_TRIS			(LED2_TRIS)			// No such LED//ROBERTO:(LED2_TRIS)
#define LED6_IO				(LATDbits.LATD4)//ROBERTO:(LATDbits.LATD6)
#define LED7_TRIS			(LED2_TRIS)			// No such LED//ROBERTO:(LED2_TRIS)
#define LED7_IO				(LATDbits.LATD4)//ROBERTO:(LATDbits.LATD6)
#define LED_GET()			((unsigned char)LATD & 0x07)
#define LED_PUT(a)			do{LATD = (LATD & 0xFFF8) | ((a)&0x07);}while(0)

// Momentary push buttons
#define BUTTON0_TRIS		(TRISDbits.TRISD5)	// Ref SW1//ROBERTO:(TRISDbits.TRISD6)
#define BUTTON0_IO			(PORTDbits.RD5)//ROBERTO:(PORTDbits.RD6)
#define BUTTON1_TRIS		(TRISDbits.TRISD5)	// Ref SW2//ROBERTO:(TRISDbits.TRISD7)
#define BUTTON1_IO			(PORTDbits.RD5)//ROBERTO:(PORTDbits.RD7)
#define BUTTON2_TRIS		(TRISDbits.TRISD5)	// Ref SW3//ROBERTO:(TRISDbits.TRISD13)
#define BUTTON2_IO			(PORTDbits.RD5)//ROBERTO:(PORTDbits.RD13)
#define BUTTON3_TRIS		(TRISDbits.TRISD5)	// No BUTTON3 on this board//ROBERTO:(TRISDbits.TRISD13)
#define BUTTON3_IO			(1)
...
#define UARTTX_TRIS			(TRISFbits.TRISF5)//ROBERTO : CHANGE TO UART2 IN PINGUINO PIC32 OTG
...
#define MRF24W_IN_SPI2
	...
	// MRF24W in SPI2 slot
	#define WF_CS_TRIS			(TRISFbits.TRISF0)//ROBERTO: (TRISFbits.TRISG9)
	#define WF_CS_IO			(LATFbits.LATF0)//ROBERTO: (LATGbits.LATG9)
	#define WF_SDI_TRIS			(TRISGbits.TRISG7)//BIEN
	#define WF_SCK_TRIS			(TRISGbits.TRISG6)//BIEN
	#define WF_SDO_TRIS			(TRISGbits.TRISG8)//BIEN
	#define WF_RESET_TRIS		TRISDbits.TRISD9//(TRISDbits.TRISD6)//ROBERTO:(TRISGbits.TRISG0)
	#define WF_RESET_IO			LATDbits.LATD9//(LATDbits.LATD6)//ROBERTO:(LATGbits.LATG0)
	#define WF_INT_TRIS			(TRISDbits.TRISD10)	// INT3//ROBERTO:(TRISAbits.TRISA14)
	#define WF_INT_IO			(PORTDbits.RD10)
	#define WF_HIBERNATE_TRIS	(TRISDbits.TRISD6)//ROBERTO:(TRISGbits.TRISG1)
	#define WF_HIBERNATE_IO		(PORTDbits.RD6)//ROBERTO:(PORTGbits.RG1)
